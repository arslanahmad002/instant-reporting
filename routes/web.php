    ...
    Route::middleware('Routing')->group(function () {
        ...
        Route::prefix('upload_data')->name('upload_data.')->group(function () {
            Route::prefix('transactions')->name('transactions.')->group(function () {
                Route::get( '/', [TransactionDataController::class, 'index'])->name('index');
                Route::post( '/', [TransactionDataController::class, 'index'])->name('filter.index');
                Route::post( '/list', [TransactionDataController::class, 'all'])->name('list');
                Route::get( '/files', [TransactionDataController::class, 'files'])->name('files');
            ...
            Route::prefix('transactions')->name('transactions.')->group(function () {
                ...
                Route::prefix('sending')->name('sending.')->group(function () {
                    Route::prefix('revenue')->name('revenue.')->group(function () {
                        ...
                        Route::post('/', [RevenueController::class, 'filter'])->name('list');
                    });
                    // profit & loss
                ...
                Route::prefix('receiving')->name('receiving.')->group(function () {
                    Route::prefix('revenue')->name('revenue.')->group(function () {
                        ...
                        Route::post('/', [ReceivingRevenueController::class, 'filter'])->name('list');
                    });
                    // profit & loss
                    Route::prefix('profit_loss')->name('profit_loss.')->group(function () {
